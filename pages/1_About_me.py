...
st.header("🔭 Projects & Domains")

st.markdown("""
- 🧠 Generative AI for vision and language [DistilGPT2 Chatbot](https://github.com/Aditi-balaji-13/distilgpt2_chatbot)  
- 💹 Quantitative modeling for financial markets  
  [Financial Market Analysis](https://github.com/Aditi-balaji-13/Financial_market_Analysis) | 
  [Optiver Closing Price Prediction](https://github.com/Aditi-balaji-13/Optiver_closing_price_prediction)  
- 🔍 Retrieval-Augmented Generation (RAG) and LLM-based systems — *Code Private*  
- 🛰️ Real-time computer vision applications for satellite and aerospace — *Code Private*  
- 🔁 Reinforcement learning for decision-making environments  
  [Reinforcement Learning](https://github.com/Aditi-balaji-13/Reinforcement_learning)  
- 🧠 Graph Neural Networks (GNNs) for spatiotemporal and scientific data  
  [GNN-Based Grain Growth](https://github.com/Aditi-balaji-13/GNN_based_grain_growth)  
- 📊 Big data processing with scalable cloud workflows  
  [Big Data Project](https://github.com/Aditi-balaji-13/Big_data)
""")

st.markdown("---")

st.subheader("📫 Reach me at:")

st.markdown("""
    <div style="text-align:center;">
      <a href="https://github.com/Aditi-balaji-13" target="_blank" style="margin-right: 20px;">
...
st.subheader("Programming Languages and Tools")
st.markdown("""
<p align="center">
